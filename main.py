...
if __name__ == '__main__':
    ...
    train_dataset = DigitsDataset(filename='/home/adrian/Data/Digits/optdigits.tra')
    test_dataset = DigitsDataset(filename='/home/adrian/Data/Digits/optdigits.tes')
    ...
    print('Testing the trained model on the training data.')
    ...
    print('Testing the trained model on the testing data.')
    metrics = test(model=model,
    ...
    torch.save(model.state_dict(), './digit-mlp.pt')
